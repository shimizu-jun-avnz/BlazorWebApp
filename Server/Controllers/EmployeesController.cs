...
namespace BlazorWebApp.Server.Controllers
{
    ...
    public class EmployeesController : ControllerBase
    {
        ...
        public async Task<ActionResult<IEnumerable<Employee>>> GetEmployee()
        {
            ...
            var job = await _context.Job_code_master.ToListAsync();
            var dep = await _context.Department_code_master.ToListAsync();
            var div = await _context.Division_code_master.ToListAsync();
